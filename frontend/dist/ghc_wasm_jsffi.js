...
ZC0ZCjsaddlezmwasmzm0zi0zi0zi0zminplaceZCLanguageziJavascriptziJSaddleziWasmZC: ($1,$2) => ((new TextDecoder('utf-8', {fatal: true})).decode(new Uint8Array(__exports.memory.buffer, $1, $2))),
ZC1ZCjsaddlezmwasmzm0zi0zi0zi0zminplaceZCLanguageziJavascriptziJSaddleziWasmZC: ($1,$2,$3) => ((new TextEncoder()).encodeInto($1, new Uint8Array(__exports.memory.buffer, $2, $3)).written),
ZC2ZCjsaddlezmwasmzm0zi0zi0zi0zminplaceZCLanguageziJavascriptziJSaddleziWasmZC: ($1) => ($1.length),
ZC3ZCjsaddlezmwasmzm0zi0zi0zi0zminplaceZCLanguageziJavascriptziJSaddleziWasmZC: async ($1,$2,$3) => (new Function('processResult','readBatch',`(()=>{${$1}})()`)($2, $3)),
ZC5ZCjsaddlezmwasmzm0zi0zi0zi0zminplaceZCLanguageziJavascriptziJSaddleziWasmZC: ($1) => (() => __exports.ghczuwasmzujsffiZC4ZCjsaddlezmwasmzm0zi0zi0zi0zminplaceZCLanguageziJavascriptziJSaddleziWasmZC($1)),
ZC7ZCjsaddlezmwasmzm0zi0zi0zi0zminplaceZCLanguageziJavascriptziJSaddleziWasmZC: ($1) => ((a1) => __exports.ghczuwasmzujsffiZC6ZCjsaddlezmwasmzm0zi0zi0zi0zminplaceZCLanguageziJavascriptziJSaddleziWasmZC($1,a1)),
